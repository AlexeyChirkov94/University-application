...
insert into forms_of_education (name) values ('full-time'), ('correspondence') ,('distance') ,('evening');
insert into groups_of_students (name, department_id, forms_of_education_id) values ('History Group №1', 1, 1);
insert into groups_of_students (name, department_id, forms_of_education_id) values ('History Group №2', 1, 2);
insert into forms_of_lesson (name, duration_of_lesson) values ('lecture', 60), ('practice', 120);
...
insert into lessons (course_id, timeOfStart, group_id, professor_id, forms_of_lesson_id)
values (1, '2020-01-11 10:00:00', 1, 7, 1),
(1, '2020-01-11 12:00:00', 1, 7, 2),
(3, '2020-01-11 14:00:00', 1, 8, 1),
(4, '2020-01-11 18:00:00', 2, 9, 1),
(4, '2020-01-11 20:00:00', 2, 9, 2);

INSERT INTO roles_of_users (name)
