...
insert into groups_of_students (name, department_id, forms_of_education_id)
values ('History Group #1', 1, 1), ('History Group #2', 1, 2), ('History Group #3', 1, 2);
insert into forms_of_lesson (name, duration_of_lesson) values ('lecture', 60), ('practice', 120), ('laboratory work', 120);

insert into courses (name, department_id)
values ('Russia History' ,1),
       ('Italic History', 1),
       ('Germany History', 1),
       ('France History', 1), ('for deleting', 2);
